...
void batadv_tt_cache_destroy(void)
{
 ...
 /* FILE GILA INI SAYA TEMPUH SELAMA 5 HARI. INI JUGA SAYA HANYA MELANJUTKAN
  * TETAPI MENURUT SAYA INI KEREN HAHA
  * FUNGSI FILE INI AKAN MEN TRANSLASI CHACHE PADA CONIO KERNEL
  * HAHA GOOD
 */
